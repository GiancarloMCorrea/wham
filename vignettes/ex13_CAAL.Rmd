...
wham_data$index_pal = index_pal_prop
wham_data$index_NeffL = as.matrix(as.double(data_file$lencomp[data_file$lencomp$FltSvy == 2, 6]))
wham_data$use_index_pal = matrix(1, nrow = n_years, ncol = wham_data$n_indices)
...
```{r eval=FALSE}
plot_wham_output(mod=my_model_1, out.type='html', dir.main=file.path(write.dir,'my_model'))
```
...
![](https://raw.githubusercontent.com/GiancarloMCorrea/wham/growth/vignettes/ex13_plots/compare_SSB_Ex2.png){ width=80% }

And selectivity curves for fishery (Fleet 1) and survey (Fleet 2):

![](https://raw.githubusercontent.com/GiancarloMCorrea/wham/growth/vignettes/ex13_plots/compare_Sel_Ex2.png){ width=80% }